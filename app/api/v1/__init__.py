    ...
    from .endpoints.health_events import router as health_events_router
    from .endpoints.reproductive_events import router as reproductive_events_router
    from .endpoints.offspring_born import router as offspring_born_router
    from .endpoints.weighings import router as weighings_router
    from .endpoints.feedings import router as feedings_router
    from .endpoints.transactions import router as transactions_router
    from .endpoints.batches import router as batches_router
    from .endpoints.grupos import router as grupos_router
    from .endpoints.animal_groups import router as animal_groups_router
